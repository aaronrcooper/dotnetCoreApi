...
namespace APITest.Domain
{
    public class TodoContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Admin Guid
            Role adminRole = new Role() { Id = new Guid("a8cc16b7-aa6b-47d3-909a-06fdcae81619"), UserRole = "Administrator" };
            builder.Entity<Role>().HasData(adminRole);
            builder.Entity<Role>().HasData(new Role() { Id = new Guid("8110bff0-12a7-4cc7-906d-a9c052727e06"), UserRole = "User" });
            ...
            builder.Entity<User>().HasData(new User() { HashedPassword = "Ov4B87zmh9j/dEG/y/BQlT3S8FA=", Id = new Guid("eaa559e4-090c-4706-a776-ffa16e7a2191"),
